...
pygame.display.set_caption("Bossfighters v0.1.11")
FPS = 40
clock = pygame.Clock()
...
current_characters_list = [characters_list[0],characters_list[1],characters_list[2],characters_list[3],characters_list[4]]
...
characters_speed = {
    ...
    characters_list[21]:2,
    characters_list[22]:2,
    characters_list[23]:2,
    characters_list[24]:2,
    characters_list[25]:2,
    characters_list[26]:2,
...
characters_health = {
    ...
    characters_list[19]:9999,
    characters_list[20]:9999,
    characters_list[21]:9999,
    characters_list[22]:9999,
    characters_list[23]:9999,
    characters_list[24]:9999,
    characters_list[25]:9999,
    characters_list[26]:9999,
        ...
        for animation in self.animation_types:
            ...
            for file in os.listdir(path):
                if file.lower().endswith(('.png' )) or file.lower().endswith(('.jpeg' )) :
                    ...
                    if file.lower().endswith(('.png' )) and self.identity not in NT_characters_list:
                        image_resized = pygame.transform.scale(image,(image.get_width()*0.7,image.get_height()*0.7))
                       
                            
                    else:
                        image_resized = pygame.transform.scale(image,(image.get_width()*0.2,image.get_height()*0.2))
            ...
            for file in os.listdir(path):
                if file.lower().endswith('.png') or file.lower().endswith('.jpeg'):
                    ...
                    if file.lower().endswith('.png') and self.identity not in NT_characters_list:
                        ...
                        image_resized = pygame.transform.flip(pygame.transform.scale(image,(image.get_width()*0.2,image.get_height()*0.2)).convert_alpha(),True,False)
